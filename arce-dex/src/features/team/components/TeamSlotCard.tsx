...
export function TeamSlotCard({
  ...
  if (!slot.pokemon) {
    return (
      <article className="grid min-h-[112px] grid-cols-[50px_minmax(0,1fr)] gap-3 rounded-2xl border border-line bg-surface-2 p-3">
        <span className="grid h-[42px] w-[42px] place-items-center rounded-2xl border border-dashed border-[rgba(246,237,211,0.2)] bg-[rgba(246,237,211,0.03)] text-muted">
          {slotIndex + 1}
        </span>
        <div>
  ...
  return (
    <article
      className={
        isSelected
          ? 'relative grid min-h-[112px] grid-cols-[50px_minmax(0,1fr)] gap-3 overflow-hidden rounded-2xl border border-[rgba(212,175,55,0.4)] bg-[rgba(212,175,55,0.08)] p-3 shadow-[0_8px_24px_rgba(0,0,0,0.4),inset_0_0_20px_rgba(212,175,55,0.05)]'
    ...
    >
      ...
      <div className="relative z-[1] min-w-0">
        ...
        <dl className="mt-2.5 grid grid-cols-[repeat(auto-fit,minmax(86px,1fr))] gap-2">
          <div className="min-w-0 rounded-xl border border-[rgba(246,237,211,0.05)] bg-[rgba(18,22,32,0.6)] p-2 shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)]">
      ...
      <div className="col-[1/-1] grid grid-cols-2 gap-2">
        <button
          className="inline-flex min-h-[44px] items-center justify-center gap-2 rounded-control border border-line bg-[rgba(246,237,211,0.04)] transition-colors hover:border-[rgba(246,237,211,0.25)] hover:bg-[rgba(246,237,211,0.08)] hover:text-ivory"
          type="button"
