...
export function AddToTeamDialog({
  ...
  return (
    ...
    >
      <section
        className="mx-auto grid max-h-[min(760px,92svh)] w-[min(520px,100%)] gap-3.5 overflow-y-auto rounded-2xl border border-line bg-ink-blue/98 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.4)]"
        role="dialog"
        aria-modal="true"
      >
